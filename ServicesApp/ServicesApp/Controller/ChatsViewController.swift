...
//
//    let currentUser = Sender(senderId: "one", displayName: "one")
//    let otherUser = Sender(senderId: "two", displayName: "two")
//
//    var message = [MessageType]()
//
//    override func viewDidLoad() {
//        super.viewDidLoad()
//        message.append(Message(sender: currentUser, messageId: "12344", sentDate: Date().addingTimeInterval(-888), kind: .text("hi")))
//        message.append(Message(sender: otherUser, messageId: "12345", sentDate: Date().addingTimeInterval(-999), kind: .text("hello")))
//        message.append(Message(sender: currentUser, messageId: "12346", sentDate: Date().addingTimeInterval(-1005), kind: .text("how are u")))
//        message.append(Message(sender: otherUser, messageId: "12347", sentDate: Date().addingTimeInterval(-1010), kind: .text("good")))
...
//        ////                                    self.sender = Sender(senderId: id, displayName: name)
//        ////                                   if let sentDate = message["created"] as? Timestamp,
//        ////                                    let senderIdx = message["senderId"] as? String,
//        ////                                      let senderNamex = message["senderName"] as? String{
//        ////                                       self.sentDate = sentDate.dateValue()
//        ////                                           self.sender = Sender(senderId: senderIdx, displayName: senderNamex)
//        ////                                       switch documentChange.type{
//        ////                                       case .added:
//        ////                                           let messageChat = Message(dict: message, sender: sender, kind: .text(text), sentDate: sentDate)
