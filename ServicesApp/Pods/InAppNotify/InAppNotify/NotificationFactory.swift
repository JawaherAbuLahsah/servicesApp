...
open class NotificationFactory: UIView,UITextViewDelegate {
    ...
    public override init(frame: CGRect) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.orientationDidChange), name: NSNotification.Name.NSUbiquityIdentityDidChange, object: nil)
    }
